...
namespace Jordium.Snowflake.NET
{
    ...
    public class OverCostActionArg
    {
        ...
        /// 数据标识码
        /// </summary>
        public virtual ushort DataCenterIdId { get; set; }
        ...
        /// <param name="dataCenterIdId"></param>
        public OverCostActionArg(ushort workerId, long timeTick, int actionType = 0, int overCostCountInOneTerm = 0, int genCountWhenOverCost = 0, int index = 0, ushort dataCenterIdId = 0)
        {
