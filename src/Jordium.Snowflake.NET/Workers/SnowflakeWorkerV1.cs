...
namespace Jordium.Snowflake.NET
{
    ...
    /// 雪花漂移算法
    /// </summary>
    internal class SnowflakeWorkerV1 : ISnowflakeWorker
    {
        /// <summary>
        /// 基础时间
        /// </summary>
        ...
        /// 数据标识码
        /// </summary>
        protected readonly ushort DataCenterId = 0;
        ...
        public SnowflakeWorkerV1(IDGeneratorOptions options)
        {
            ...
            if (DataCenterId < 0)
            {
                DataCenterId = (ushort)DateTime.Now.Millisecond;
            }
        ...
        public virtual long NextId()
        {
            lock (_SyncLock)
            {
                var id = _IsOverCost ? NextOverCostId() : NextNormalId();
                return id;
            }
        }
        ...
        {
            var result = ((useTimeTick << _TimestampShift) + ((long)DataCenterId << (SeqBitLength + WorkerIdBitLength)) +
