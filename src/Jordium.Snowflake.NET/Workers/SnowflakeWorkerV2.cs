...
namespace Jordium.Snowflake.NET
{
    ...
    /// 常规雪花算法
    /// </summary>
    internal class SnowflakeWorkerV2 : SnowflakeWorkerV1
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="options"></param>
        public SnowflakeWorkerV2(IDGeneratorOptions options) : base(options)
        {
        }
        ...
        public override long NextId()
        {
            lock (_SyncLock)
            {
                ...
                var result = ((currentTimeTick << _TimestampShift) + 
